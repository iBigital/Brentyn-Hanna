  ...
  <div>
    ...
    <section>
      <div class="flex">
        <h2>Software</h2>
        <p>
          I have a passion for software development: diving deep into favored
          languages/programs or just exploring new toys to try blazing edge
          features.
        </p>
      </div>
      <br />
    ...
    <section>
      <div class="flex">
        ...
        <p>
          Creating unique systems that are easy to use and easier to maintain is
          my expertise.
        </p>
      </div>
      <SkillCard
      ...
      <SkillCard
        id="flip-it"
        title="Custom"
        description="I can help you build your hardware to your specifications."
      />
      <SkillCard
    ...
    <section>
      <div class="flex">
        ...
        <p>I've worked on a number of projects with other developers.</p>
      </div>
      <ExtendedCard
        title="Todo Simply"
